        ...
        <ul className="flex items-center gap-3 ">
          <li>
            <Button className="bg-blue-600  ">
              <Link href="https://github.com/Yukesh-yukii">Github</Link>
            </Button>
          </li>
        </ul>
      </nav>
        ...
        <main className="my-10 py-10 bg-slate-700 rounded-lg items-start flex flex-col justify-start gap-2">
          <div className="w-full">
            <div className="rounded-md flex justify-center items-center ">
              <video
                className="rounded-md p-3 transition duration-300 ease-in-out transform scale-100 hover:scale-110 hover:rounded-md opacity-100 hover:opacity-100 "
